...
const KEYS: &[(&str, &[(&str, &str)])] = &[
    (
        ...
        &[
            ...
            ("G", "zoom to the selection's neighbourhood"),
    ...
    (
        ...
        &[
            ...
            ("Ctrl+Q", "let go of everything: focus, cursor, selection"),
            ("click away", "release focus back to the graph"),
